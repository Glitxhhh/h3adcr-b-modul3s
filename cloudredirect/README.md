...
Vendored from [slsteammoon-ltsteamplugin](https://codeberg.org/unplausible/slsteammoon-ltsteamplugin)'s
`cloudredirect/` directory so headcrab's own installer (`crinstall()` in
`headcrab.sh`) deploys this patched build instead of vanilla upstream.
